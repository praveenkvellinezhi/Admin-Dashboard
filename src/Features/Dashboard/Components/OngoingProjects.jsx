...
const dummyProjects = [
  {
    ...
    description: "Internal dashboard for HR team",
    progress: 85,
    due_date: "25 Feb 2026",
  },
  {
    id: 2,
    name: "Dukhaan website",
  ...
  {
    id: 3,
    name: "Fellobell mobile app",
    description: "Hair cut booking app",
    progress: 30,
    due_date: "05 Apr 2026",
  },
];
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
      ...
      <div className="divide-y divide-gray-300">
        {projects.map((p) => (
          <div key={p.id} className="flex items-center gap-6 px-6 py-5">
