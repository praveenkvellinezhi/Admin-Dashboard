export default function PhaseCard({ phase ,onClick }) {
  ...
  const progress =
    phase.tasks.length > 0
      ? Math.round((completedCount / phase.tasks.length) * 100)
      : 0;

  return (
    <div 
    onClick={onClick}
    className="w-64 bg-white border border-gray-200 rounded-xl shadow-sm p-4 flex flex-col justify-between">
